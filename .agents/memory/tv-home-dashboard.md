...
- **Grid alignment:** Measure a flex content rail (never the intrinsic Recently Watched strip) and share one 16:9 card geometry across the rails. Cap card width from the measured content viewport so four cards, gaps, and horizontal padding fit beside the sidebar; independently derived widths show only three cards.
