...
- **Grid alignment:** Measure one TV content-rail body and use that exact card height and derived width for every main rail; independently rounded flex heights drift columns. Sync focus scrolling without animation.
