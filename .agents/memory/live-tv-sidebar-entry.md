...
- **How to apply:** Resolve the channel's provider category to its category node, expose that focus action to the screen's BACK handler, and distinguish a category→sidebar blur from a category→channel blur.